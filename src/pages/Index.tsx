    ...
    <>
      ...
      >
        ...
        <div className="absolute right-[5%] top-0 h-full w-1/2 pointer-events-none hidden md:block">
          <svg
            className="absolute right-0 top-[55%] -translate-y-1/2 w-[500px] lg:w-[600px] h-[500px] lg:h-[600px]"
            viewBox="0 0 600 600"
            fill="none"
          ...
          <div className="mt-12 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
            {clientsData.map((client, i) => (
              <AnimatedSection key={client.name} delay={i * 0.05}>
                <ClientLogoCard name={client.name} logo={client.logo} logoClassName={client.name === "OpenClassrooms" ? "h-[110px] w-[340px] max-w-none object-cover grayscale group-hover:grayscale-0 transition-all duration-300" : undefined} />
              </AnimatedSection>
            ))}
          </div>
