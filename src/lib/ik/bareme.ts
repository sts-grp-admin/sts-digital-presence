// Barème kilométrique VOITURE — taux DGFiP gelés depuis 2023 (inchangés 2024-2026).
// Source : economie.gouv.fr / LégiSocial. Véhicule 100 % électrique : majoration +20 %.
//
// Le barème est ANNUEL, à 3 tranches déterminées par le CUMUL de km depuis le
// 1er janvier (jamais par les km du mois) :
//   d ≤ 5 000        → d × c1
 ...
 * les passages de tranche (le mois qui franchit 5 000 km est payé en partie
 * sur chaque tranche, via la différence des deux formules).
 */
